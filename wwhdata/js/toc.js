...
{
var A=P.fN("Welcome to the caBIO Portlet Online Help","0");
var B=A.fN("Using the Online Help","1");
A=P.fN("Using the caBIO Portlet","2");
B=A.fN("Understanding the caBIO Portlet","3");
B=A.fN("Searching for caBIO Data","4");
