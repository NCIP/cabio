...
================================================================
    ...
    a local version of caBIO version 4.2 on a machine running a
...
----------------------------------------------------------------
    ...
    The cabio42.war file should be dropped into the Tomcat 
    webapps directory.
...
----------------------------------------------------------------
    ...
    Copy the deploy/cabio42.war to the JBoss deploy directory 
    and restart JBoss.
...
================================================================
    ...
    -DSERVER_URL="http://yourserver/cabio42"
    ...
    The cabio42.war file will be saved to your output\webapp
...
================================================================
    ...
    The caBIO version 4.2 software is licensed under the terms
