...
create index GENE_TVE_TV_SOURCE on GENE_TV(SOURCE) PARALLEL NOLOGGING tablespace CABIO_FUT;
create index GENE_TVE_TV_ENTREZ_ID on GENE_TV(ENTREZ_ID) PARALLEL NOLOGGING tablespace CABIO_FUT;
