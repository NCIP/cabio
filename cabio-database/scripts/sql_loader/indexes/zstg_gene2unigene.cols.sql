...
create index ZSTG_GENGENE_TAXON on ZSTG_GENE2UNIGENE(TAXON) PARALLEL NOLOGGING tablespace CABIO_MAP_FUT;
create index ZSTG_GENGENE_UCLUSTER on ZSTG_GENE2UNIGENE(UCLUSTER) PARALLEL NOLOGGING tablespace CABIO_MAP_FUT;
