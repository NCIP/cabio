...
public class DefaultObjectCache
  implements ObjectCache, Runnable
{
    ...
    throws CacheException
  {
	...
	Class.forName( COREUtilities
		       .getSCClassName( beanName ) ).newInstance();
  ...
  public void put( String beanName, Object[] objects )
    throws CacheException
  {
    try{
      SearchCriteria sc = (SearchCriteria)
  ...
  public SearchResult get( SearchCriteria sc )
    throws CacheException
  {
  ...
  public void put( SearchCriteria sc, SearchResult sr )
    throws CacheException
  {
    try{
  ...
  public void run(){
	...
	ex.printStackTrace();
      ...
      try{
	_sleepTime = 
	  new Integer( System.getProperty( "ObjectCacheSaveInterval" ) ).intValue();
      }catch( Exception ex ){
	//nothing
      }
    }
