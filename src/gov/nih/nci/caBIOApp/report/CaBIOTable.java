...
public class CaBIOTable 
  extends DefaultTableModel
  implements Table, Datasource
{
  ...
  public Object clone(){
    ...
    for( int rowIndex = 0; rowIndex < numRows; rowIndex++ ){
      for( int columnIndex = 0; columnIndex < numColumns; columnIndex++ ){
	       table.setStringValueAt(new String(getStringValueAt(rowIndex, columnIndex)),rowIndex, columnIndex );
      }
    }
    return table;
  }
  public String toString() {
	...
	//System.out.println("Number of columns in the FinalTable: " + columnCount + "\n");
