...
public class AppConfig{
  ...
  */
  public void setupLogger( LoggerInfo li )
    throws FileNotFoundException, SecurityException
  {
	...
	MessageLog.setInfoStream( new PrintStream( new FileOutputStream( infoLogFileName ) ) );
	...
	MessageLog.setWarningStream( new PrintStream( new FileOutputStream( warningLogFileName ) ) );
	...
	MessageLog.setErrorStream( new PrintStream( new FileOutputStream( errorLogFileName ) ) );
  ...
  public ActionParams getActionParams( String path ){
    ...
    private Config unmarshalConfig()
	throws ConfigurationException
    {
      Config config = null;
      String filename =
	System.getProperty( "gov.nih.nci.caBIOApp.config.filename" );
