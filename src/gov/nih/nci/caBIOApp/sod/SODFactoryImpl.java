...
public class SODFactoryImpl
    implements SODFactory
{
    ...
    private void unmarshalDescription()
	throws ConfigurationException
    {
	String filename =
	    System.getProperty( "gov.nih.nci.caBIO.ui.sod.filename" );
	...
	try{
	  ...
	  d.register( SearchableObjectsDescriptionImpl.class, SearchableObjectsDescriptionImplImpl.class );
	  d.register( SearchableObjectImpl.class, SearchableObjectImplImpl.class );
