...
public class ColumnSpecification{
    ...
    throws InvalidSpecificationException
  {
    ...
    if( so == null ){
      throw new InvalidSpecificationException( "SearchableObject not found for: " + objectName );
    }

    Attribute att = _sod.getAttribute( so, attributeName );
    if( att == null ){
      throw new InvalidSpecificationException( "Attribute not found for: " + attributeName );
    }
  ...
  /*
  SearchableObjectsDescription getSOD(){
    return _sod;
  }
  */
  public boolean equals( Object o ){
    boolean eq = false;
    if( o != null &&
	o  instanceof ColumnSpecification ){
      ColumnSpecification aColSpec = (ColumnSpecification)o;
      if( aColSpec.getId() != null &&
	  aColSpec.getId().equals( _id ) ){
	eq = true;
      }
    }
    return eq;
