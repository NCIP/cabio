...
public class FormUtils{
    public static ActionError validateRequiredName( String name,
						    String msgKey, String[] subs ){
	...
	ActionError error = null;
	switch( subs.length ){
	case 0: error = new ActionError( msgKey ); break;
	case 1: error = new ActionError( msgKey, subs[0] ); break;
	case 2: error = new ActionError( msgKey, subs[0], subs[1] ); break;
	case 3: error = new ActionError( msgKey, subs[0], subs[1], subs[2] ); break;
	case 4: error = new ActionError( msgKey, subs[0], subs[1], subs[2], subs[3] ); break;
	default: throw new IllegalArgumentException( "Only less four or fewer substitutions allowed." );
	}
	return error;
    }
