...
public class OntologyTree extends WebTree{
  ...
  private void init(){
	...
	String serFilename = 
	  props.getProperty( "gov.nih.nci.caBIOApp.ui.OntologyTree.cacheDir" ) +
	...
	if( serFile.exists() ){
	  ...
	  TreeBuilder tb = (TreeBuilder)
	    Class.forName( ontInfo.getTreeBuilder() )
	    .newInstance();
    ...
    throws Exception
  {
    ...
    MessageLog.printInfo( "...tree is " + ( tree == null ? "" : "not" ) + " null" );
    return tree;
  }
  public Vector getSynonyms( String term )
    throws Exception
  {
  ...
  private void serializeTree( DefaultMutableTreeNode tree,
			      File file )
    throws Exception
  {
  ...
  private DefaultMutableTreeNode deserializeTree( File file )
    throws Exception
  {
  ...
  public static void main( String[] args ){
	...
	DefaultMutableTreeNode node = 
	  (DefaultMutableTreeNode)ois.readObject();
