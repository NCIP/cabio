...
create index ZSTG_CHOME_BIG_ID_lwr on ZSTG_CHROMOSOME(lower(BIG_ID)) PARALLEL NOLOGGING tablespace CABIO_MAP_FUT;
...
create index ZSTG_AGENT_BIG_ID_lwr on ZSTG_AGENT(lower(BIG_ID)) PARALLEL NOLOGGING tablespace CABIO_MAP_FUT;
