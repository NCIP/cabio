...
$SQLLDR $1 readsize=1000000 rows=100000 control=zstg_rna_probesets.ctl log=ZSTG_RNA_Probesets.ctl.log bad=ZSTG_RNA_Probesets.ctl.bad direct=true skip=1 errors=50000
$SQLLDR $1 readsize=1000000 rows=100000 control=ZSTG_RNA_Probesets_2.ctl log=ZSTG_RNA_Probesets_2.ctl.log bad=ZSTG_RNA_Probesets_2.ctl.bad direct=true skip=1 errors=50000
#$SQLLDR $1 readsize=1000000 rows=100000 control=ZSTG_RNA_Probesets_3.ctl log=ZSTG_RNA_Probesets_3.ctl.log bad=ZSTG_RNA_Probesets_3.ctl.bad direct=true skip=1 errors=50000
