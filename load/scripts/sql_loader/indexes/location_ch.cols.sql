...
create index LOCATIONN_CH_CONSERVATI on LOCATION_CH(CONSERVATION_PVALUE) PARALLEL NOLOGGING tablespace cabio_fut;
create index LOCATIONN_CH_CONSERVATI on LOCATION_CH(CONSERVATION_SCORE) PARALLEL NOLOGGING tablespace cabio_fut;
create index LOCATIONN_CH_MULTIPLE_A on LOCATION_CH(MULTIPLE_ALIGNMENT_ID) PARALLEL NOLOGGING tablespace cabio_fut;
