...
create index LOCATIO_CH_BIG_ID on LOCATION_CH(BIG_ID) tablespace CABIO_FUT;
...
create index LOCATIO_43_BIG_ID on LOCATION_CH_43(BIG_ID) tablespace CABIO_FUT;
create index GENE_FU_43_BIG_ID on GENE_FUNCTION_ASSOCIATION_43(BIG_ID) tablespace CABIO_FUT;
create index EVIDENC_43_BIG_ID on EVIDENCE_43(BIG_ID) tablespace CABIO_FUT;
...
create index ARRAY_RNEW_BIG_ID on ARRAY_REPORTER_NEW(BIG_ID) tablespace CABIO_FUT;
...
create index AGENT_OOLD_BIG_ID on AGENT_OLD(BIG_ID) tablespace CABIO_FUT;
