...
@$LOAD/indexer_new.sql gene_function_association_evidence;
...
@$LOAD/constraints.sql gene_function_association_evidence;
...
@$LOAD/constraints/gene_function_association_evidence.disable.sql;
...
truncate table gene_function_association_evidence;
...
@$LOAD/indexes/gene_function_association_evidence.drop.sql;
