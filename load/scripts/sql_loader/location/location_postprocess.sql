...
CREATE INDEX LOCHCHENDPOS ON location_ch (CHROMOSOMAL_END_POSITION);
CREATE INDEX LOCCHBIGID ON location_ch(BIG_ID);
ANALYZE TABLE physical_location COMPUTE STATISTICS;
ANALYZE TABLE location_tv COMPUTE STATISTICS;
ANALYZE TABLE location_ch COMPUTE STATISTICS;
EXIT;
