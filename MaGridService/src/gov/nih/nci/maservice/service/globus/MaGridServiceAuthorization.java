 ...
 * 
 */
public class MaGridServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://maservice.nci.nih.gov/MaGridService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public MaGridServiceAuthorization() {
	}
