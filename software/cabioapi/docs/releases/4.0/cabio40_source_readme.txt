...
================================================================
    ...
    a local version of caBIO version 4.0 on a machine running a
...
----------------------------------------------------------------
    ...
    The cabio40.war file should be dropped into the Tomcat 
    webapps directory.
...
----------------------------------------------------------------
    ...
    Copy the deploy/cabio40.war to the JBoss deploy directory 
    and restart JBoss.
...
================================================================
    ...
    -DSERVER_URL="http://yourserver/cabio40"
    ...
    The cabio40.war file will be saved to your output\webapp
...
================================================================
    ...
    The caBIO version 4.0 software is licensed under the terms
