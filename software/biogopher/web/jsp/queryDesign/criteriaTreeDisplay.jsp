...
<jsp:useBean id="criteriaTreeBean" 
             class="gov.nih.nci.caBIOApp.ui.tree.CriteriaSummaryTreeBean"
	     scope="session"/>

<% gov.nih.nci.caBIOApp.ui.tree.TreeBean treeBean = criteriaTreeBean; %>
