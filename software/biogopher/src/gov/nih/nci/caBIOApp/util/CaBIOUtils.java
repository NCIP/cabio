...
public class CaBIOUtils {
    ...
    public static gov.nih.nci.caBIO.bean.Ontologable getOntologyRoot(
    ...
    */
    public static SearchCriteria newSearchCriteria(String beanName)
        ...
        return (SearchCriteria) Class.forName(
    ...
    public static Object getProperty(Object obj, String propName)
        ...
        if (methodName == null) {
            throw new Exception("No getter found on "
                    + obj.getClass().getName() + " for property " + propName);
        }
    ...
    public static String getMethodName(Object obj, String propName)
        ...
        if (m == null) {
            if (propName.indexOf("is") != -1) {
                ...
                methodName = "get" + propName.substring(0, 1).toUpperCase()
                        + propName.substring(1);
            }
    ...
    public static SearchCriteria reverseSearchCriteria(String beanName,
            String id, String roleName) throws Exception {
        ...
        if (assoc == null) {
            throw new Exception("Couldn't find association with roleNam "
                    + roleName + " on " + beanName);
        }
        ...
        String recipRole = CaBIOUtils.getReciprocalRole(beanName + "."
                + roleName);
