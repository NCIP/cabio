    ...
    public static synchronized void setPrintArea(String filePrint, String file,
        ...
        if (filePrint != null) {
            try {
                ...
                if (filePrint == "all") {
                    ...
                    setInfoStream(ps);
                else if (filePrint == "warning") setWarningStream(ps);
            }
        ...
        if (displayPrint != null) {
            if (displayPrint == "all") {
                ...
                setInfoStream(System.out);
            else if (displayPrint == "warning") setWarningStream(System.out);
        }
        if (toggleOn != null) {
            if (toggleOn == "all") {
                setErrorOn(true);
                ...
                setInfoOn(true);
            else if (toggleOn == "warning") setWarningOn(true);
        }
        if (toggleOff != null) {
            if (toggleOff == "all") {
                setErrorOn(false);
                ...
                setInfoOn(false);
            else if (toggleOff == "warning") setWarningOn(false);
        }
    }
