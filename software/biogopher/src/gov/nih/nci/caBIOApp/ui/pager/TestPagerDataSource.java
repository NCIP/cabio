...
import gov.nih.nci.caBIO.bean.SearchCriteria;

import java.util.ArrayList;
import java.util.List;

public class TestPagerDataSource extends CaBIOPagerDataSource implements
        PagerDataSource {

    private ArrayList _items = new ArrayList();

    public TestPagerDataSource(String classname, SearchCriteria criteria,
            List joins) {
