...
public class CriteriaSummaryTreeBean extends TreeBean {
    ...
    public void buildTree(DefaultMutableTreeNode displayNode,
        ...
        for (Iterator i = parentSC.getObjectNodes().iterator(); i.hasNext();) {
            ...
            if (aChild.isPathItem()) {
                ...
                */
                ...
                if (((SearchCriteriaNode) parent).isPathItem()
                        && !aChild.isPathItem()) {
                    //PathItems are no longer supported
                    throw new RuntimeException(
                            "PathItem objects are no longer supported.");
                    /**
                     * If the parent is a PathItem and aChild is not a PathItem,
                     * then
                     * aChild is an object node, because PathItems will not have
                     * any
