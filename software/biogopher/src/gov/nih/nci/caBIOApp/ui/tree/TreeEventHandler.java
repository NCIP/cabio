...
public class TreeEventHandler extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DefaultMutableTreeNode tree = (DefaultMutableTreeNode) session.getAttribute(_treeKeyName);
        if (tree != null) {
            ...
            if (bean == null) {
                try {
                    ...
                    throw new ServletException("Error instatiating tree bean",
                            ex);
                }
            ...
            if (bean == null) {
                throw new ServletException("Couldn't find bean under: "
                        + _treeBeanKeyName);
            }
