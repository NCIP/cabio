...
public class CriterionValue extends CaBIONodeContent implements Cloneable {
    ...
    public CriterionValue(SearchableObject so, String id) {
        super(id, so.getLabel(), so.getDescription(), null, null, false, null);
        _type = OBJECT_TYPE;
    ...
    public CriterionValue(SearchableObject so, Attribute att, String id) {
        super(id, (att == null ? "Ontological Property" : att.getLabel()),
                (att == null ? "This object is part of an ontology"
                        : att.getLabel()), null, null, false, null);
        MessageLog.printInfo("CriterionValue(SearchableObject,Attribute,String): "
                + "creating node"
                + ", so.getOntological() = "
                + so.getOntological() + ", id = " + id);
