...
CREATE SEQUENCE bio_pathway_ID_SEQ;
...
INSERT INTO bio_pathways_tv (pathway_name, pathway_display, taxon, source) SELECT distinct pathway_name, pathway_display, DECODE (organism, 'Hs', 5, 'Mm', 6) taxon_id, 'BioCarta' FROM cgap.biopaths@web.nci.nih.gov;
commit;
