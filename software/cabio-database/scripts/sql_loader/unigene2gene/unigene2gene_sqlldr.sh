...
$SQLLDR $1 readsize=1000000 parallel=true rows=100000 control=zstg_gene2go.ctl log=zstg_gene2go.log bad=zstg_gene2go.bad direct=true skip_index_maintenance=true errors=5000 skip=1 &
...
$SQLLDR $1 readsize=1000000 parallel=true control=zstg_gene2refseq_sqlldr.ctl log=zstg_gene2refseq_sqlldr.log bad=zstg_gene2refseq_sqlldr.bad errors=50000 direct=true silent=(HEADER) skip_index_maintenance=true skip=1 &
