...
import gov.nih.nci.cagrid.cabio.service.CaBIO42GridSvcConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class CaBIO42GridSvcResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaBIO42GridSvcResourceBase.class);

	private CaBIO42GridSvcResourceConfiguration configuration;
    ...
    public CaBIO42GridSvcResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((CaBIO42GridSvcResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaBIO42GridSvcConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaBIO42GridSvcResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaBIO42GridSvcConstants.SERVICEMETADATA);
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((CaBIO42GridSvcResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CaBIO42GridSvcResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
