 ...
 * 
 */
public class CaBIO42GridSvcAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://cabio.cagrid.nci.nih.gov/CaBIO42GridSvc";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CaBIO42GridSvcAuthorization() {
	}
