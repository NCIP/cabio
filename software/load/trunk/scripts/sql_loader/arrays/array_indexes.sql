...
@$LOAD/indexer_new.sql zstg_microsatellite
...
@$LOAD/indexer_new.sql ar_refseq_protein_tmp 
@$LOAD/indexer_new.sql ar_refseq_transcripts_tmp 
@$LOAD/indexer_new.sql ar_rep_public_id_tmp 
@$LOAD/indexer_new.sql ar_swissprot_tmp 
@$LOAD/indexer_new.sql ar_unigene_id_tmp 
