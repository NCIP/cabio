...
echo "Starting load " | mail -s "Starting load " steve.saksa@gmail.com
# Download data
...
echo "Done download " | mail -s "Finished download and library-load " steve.saksa@gmail.com
...
echo "Done Parse " | mail -s "Finished parse " steve.saksa@gmail.com
...
echo "Done Part 4 " | mail -s "Finished data load " steve.saksa@gmail.com
exit
