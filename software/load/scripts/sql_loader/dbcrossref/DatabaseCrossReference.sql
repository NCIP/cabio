...
CREATE UNIQUE INDEX GTV_TMP ON gene_tv(CLUSTER_ID, taxon_ID) NOLOGGING PARALLEL;
CREATE UNIQUE INDEX G2G_TMP ON zstg_omim2gene(OMIM_NUMBER) NOLOGGING PARALLEL;
...
CREATE INDEX GTV_TMP_IDX2 ON gene_tv('Hs' || CLUSTER_ID);
...
NOLOGGING;
CREATE INDEX AR_REFSEQ_IDX_2 ON ar_refseq_protein(REFSEQ_PROTEIN_ID);
