...
$SQLLDR $1 readsize=1000000 parallel=true control=cytoCytoloc.ctl log=cytoCytoloc.log bad=cytoCytoloc.bad errors=50000 silent=(HEADER) skip_index_maintenance=true
