...
#$SQLLDR $1 readsize=1000000 rows=100000 control=ZSTG_RNA_Probesets_3.ctl log=ZSTG_RNA_Probesets_3.ctl.log bad=ZSTG_RNA_Probesets_3.ctl.bad direct=true skip=13 errors=50000
