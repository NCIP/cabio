...
TRUNCATE TABLE zstg_gene2go REUSE STORAGE;
...
@$LOAD/indexer_new.sql zstg_gene2go;
...
@$LOAD/constraints.sql zstg_gene2go;
...
@$LOAD/triggers.sql zstg_gene2go;
...
@$LOAD/constraints/zstg_gene2go.disable.sql;
...
@$LOAD/indexes/zstg_gene2go.drop.sql;
...
@$LOAD/triggers/zstg_gene2go.disable.sql;
