...
my $out_file01 = "$outdir/RNA_probesets_out_2.txt";
my $out_file02 = "$outdir/representative_public_ID_file_out_2.txt";
my $out_file03 = "$outdir/unigene_ID_file_out_2.txt";
my $out_file04 = "$outdir/alignments_file_out_2.txt";
my $out_file05 = "$outdir/gene_title_file_out_2.txt";
my $out_file06 = "$outdir/gene_symbol_file_out_2.txt";
my $out_file07 = "$outdir/chromosomal_location_file_out_2.txt";
my $out_file08 = "$outdir/entrez_gene_file_out_2.txt";
my $out_file09 = "$outdir/swissprot_file_out_2.txt";
my $out_file10 = "$outdir/EC_out_2.txt";
my $out_file11 = "$outdir/OMIM_file_out_2.txt";
my $out_file12 = "$outdir/refseq_protein_id_file_out_2.txt";
my $out_file13 = "$outdir/refseq_transcript_id_file_out_2.txt";
my $out_file14 = "$outdir/go_biological_process_file_out_2.txt";
my $out_file15 = "$outdir/go_cellular_component_file_out_2.txt";
my $out_file16 = "$outdir/go_molecular_function_file_out_2.txt";
my $out_file17 = "$outdir/pathway_file_out_2.txt";
my $out_file18 = "$outdir/interpro_file_out_2.txt";
my $out_file19 = "$outdir/ensembl_out_2.txt";
