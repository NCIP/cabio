 ...
 * 
 */
public class CaBIO42GridSvcConfiguration implements ServiceConfiguration {

	public static CaBIO42GridSvcConfiguration  configuration = null;
    public String etcDirectoryPath;
    	
	public static CaBIO42GridSvcConfiguration getConfiguration() throws Exception {
		if (CaBIO42GridSvcConfiguration.configuration != null) {
			return CaBIO42GridSvcConfiguration.configuration;
		}
		...
		try {
			...
			CaBIO42GridSvcConfiguration.configuration = (CaBIO42GridSvcConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
